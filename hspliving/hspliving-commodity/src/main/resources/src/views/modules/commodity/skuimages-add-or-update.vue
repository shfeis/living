<template>
  <el-dialog
    ...
    <el-form-item label="默认图[1-不是默认图，0-是默认图]" prop="defaultImg">
      <el-input v-model="dataForm.defaultImg" placeholder="默认图[1-不是默认图，0-是默认图]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          defaultImg: [
            { required: true, message: '默认图[1-不是默认图，0-是默认图]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
